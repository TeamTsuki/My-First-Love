...
screen main_menu:
    ...
    frame:
        ...
        textbutton _("Start Game") action Start() text_size 40
        textbutton _("Load Game") action ShowMenu("load") text_size 40
        textbutton _("Preferences") action ShowMenu("preferences") text_size 40
        textbutton _("Help") action Help() text_size 40
...
screen navigation:
    ...
    frame:
        ...
        textbutton _("Preferences") action ShowMenu("preferences") text_size 40
        textbutton _("Save Game") action ShowMenu("save") text_size 40
        textbutton _("Load Game") action ShowMenu("load") text_size 40
        textbutton _("Main Menu") action MainMenu()
        textbutton _("Help") action Help() text_size 40
        textbutton _("Quit") action Quit() text_size 40
    ...
    grid 3 1:
        ...
        vbox:
            frame:
                ...
                label _("Display")
                textbutton _("Window") action Preference("display", "window") text_size 40
                textbutton _("Fullscreen") action Preference("display", "fullscreen") text_size 40
            ...
            frame:
                ...
                label _("Transitions")
                textbutton _("All") action Preference("transitions", "all") text_size 40
                textbutton _("None") action Preference("transitions", "none") text_size 40
            ...
            frame:
                ...
                textbutton _("Joystick...") action Preference("joystick") text_size 40
        ...
        vbox:
            frame:
                ...
                label _("Skip")
                textbutton _("Seen Messages") action Preference("skip", "seen") text_size 40
                textbutton _("All Messages") action Preference("skip", "all") text_size 40

            frame:
                style_group "pref"
                has vbox

                textbutton _("Begin Skipping") action Skip() text_size 40
            ...
            frame:
                ...
                textbutton _("Stop Skipping") action Preference("after choices", "stop") text_size 40
                textbutton _("Keep Skipping") action Preference("after choices", "skip") text_size 40
            ...
            frame:
                ...
                if config.has_voice:
                    textbutton _("Wait for Voice") action Preference("wait for voice", "toggle") text_size 40
        ...
        vbox:
            ...
            frame:
                ...
                if config.sample_sound:
                    textbutton _("Test") text_size 40:
            ...
            if config.has_voice:
                frame:
                    ...
                    textbutton _("Voice Sustain") action Preference("voice sustain", "toggle") text_size 40
...
screen quick_menu:
    ...
    hbox:
        ...
        textbutton _("Back") action Rollback() text_size 40
        textbutton _("Save") action ShowMenu('save') text_size 40
        textbutton _("Q.Save") action QuickSave() text_size 40
        textbutton _("Q.Load") action QuickLoad() text_size 40
        textbutton _("Skip") action Skip() text_size 40
        textbutton _("F.Skip") action Skip(fast=True, confirm=True) text_size 40
        textbutton _("Auto") action Preference("auto-forward", "toggle") text_size 40
        textbutton _("Prefs") action ShowMenu('preferences') text_size 40
